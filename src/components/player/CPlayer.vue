<template>
  <div class="player" v-show="playlist.length>0">
    ...
    <div class="normal-player" v-show="fullScreen">
      ...
      <b-scroll class="middle-r" ref="lyricList" :data="currentLyric && currentLyric.lines">
...
<div class="bottom">
  ...
  <div class="progress-wrapper">
    ...
    <div class="progress-bar-wrapper">
      <b-progress-bar :percent="percent" @percentChange="onProgressBarChange"></b-progress-bar>
    </div>
...
<transition name="mini">
  <div class="mini-player" v-show="!fullScreen" @click="open">
    ...
    <div class="control">
      <b-progress-circle :radius="radius" :percent="percent">
...
<c-play-list ref="playlist"></c-play-list>
<audio ref="audio"
:src="currentSong.url" 
@play="ready" 
@error="error" 
...
<script>
  ...
  import BProgressBar from '@/base/progress/BProgressBar';
  import BProgressCircle from '@/base/progress/BProgressCircle';
  import {playMode} from '@/assets/js/config';
  import Lyric from 'lyric-parser';
  import BScroll from '@/base/BScroll';
  import {playerMixin} from '@/assets/js/mixin';
  import CPlayList from '@/components/player/CPlayList';
